export default function Footer() {
  return (
    <div>
      <footer className="text-center lg:text-left mt-56">
        <div className="flex justify-center items-center lg:justify-between p-6">
          ...
          <div className="flex justify-center">
            <a
              href="https://www.facebook.com/sudipta.adak.9081/"
              target="_blank"
            ...
            <a
              href="https://github.com/Sudipta07151"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="mx-6 py-10 text-center md:text-left">
          <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            "
              ...
              <p>
                We have created this during our training time as a project work
                given by your trainer Lakshmi Sankaran
              </p>
            </div>
            <div className="">
